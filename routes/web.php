...
$router->group(['prefix' => '/v1', 'middleware' => 'auth'], function () use ($router) {
    ...
    // Search Routes
    $router->post('/search_recommendation', 'SearchController@recommendation');
    $router->post('/search_user', 'SearchController@user');
    $router->post('/search_genre', 'SearchController@genre');
    $router->post('/search_keyword', 'SearchController@keyword');
    $router->post('/search_source', 'SearchController@source');
